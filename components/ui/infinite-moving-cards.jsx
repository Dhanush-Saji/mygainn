            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span
                    className="text-sm leading-[1.6] font-semibold text-neutral-500 dark:text-gray-400">
                    {item?.name}
                  </span>
                  <span
                    className="text-xs leading-[1.6] font-normal text-neutral-500 dark:text-gray-400">
                    {item?.job}
                  </span>
                </span>
              </div>
