...
import AppDownloadBtnSection from "./AppDownloadBtnSection";
...
const BestAppSection = () => {
  ...
  const playStoreLink = `https://play.google.com/store/apps/details?id=com.xtrem.mygainn&pli=1`
  const appStoreLink = `https://apps.apple.com/in/app/mygainn/id6446614166`
  return (
    <div className="bg-(--cblue2) flex justify-between gap-4 w-[70%] mx-auto rounded-3xl overflow-hidden">
      ...
      <div className="flex flex-col gap-6 w-[60%] mr-12 my-auto">
        ...
        <div className="flex">
          <Link target="_blank" href={playStoreLink}>
          ...
          <div className="flex flex-col gap-2">
            <AppDownloadBtnSection playStoreLink={playStoreLink} appStoreLink={appStoreLink} />
          </div>
        </div>
      </div>
    </div>
